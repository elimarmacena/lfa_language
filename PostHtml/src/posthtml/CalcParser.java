...
public class CalcParser extends Parser {
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				{
				setState(54); ((StatementContext)_localctx).a = assign();
			...
			case 3:
				...
				{
				setState(58); ((StatementContext)_localctx).i = ifExpr();
			...
			case 4:
				...
				{
				setState(61); ((StatementContext)_localctx).w = whileExpr();
			...
			case 5:
				...
				{
				setState(64); ((StatementContext)_localctx).b = block();
	...
	public final IfExprContext ifExpr() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(70); ((IfExprContext)_localctx).c = bexpr();
				setState(71); match(THEN);
				setState(72); ((IfExprContext)_localctx).t = statement();
			...
			case 2:
				...
				setState(80); ((IfExprContext)_localctx).e = statement();
	...
	public final WhileExprContext whileExpr() throws RecognitionException {
		...
		try {
			...
			setState(86); ((WhileExprContext)_localctx).c = bexpr();
			setState(87); match(DO);
			setState(88); ((WhileExprContext)_localctx).d = statement();
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(91); match(LBRC);
			setState(92); ((BlockContext)_localctx).st = sttmtSeq();
			setState(93); match(RBRC);
	...
	public final SttmtSeqContext sttmtSeq() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << NUMERO) | (1L << NOT) | (1L << IF) | (1L << WHILE) | (1L << DRAWID) | (1L << IDENT) | (1L << MINUS) | (1L << LPAR) | (1L << LBRC))) != 0)) {
				{
				{
				setState(96); ((SttmtSeqContext)_localctx).s1 = statement();
	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(104); ((ExprContext)_localctx).e = bexpr();
	...
	public final AssignContext assign() throws RecognitionException {
		...
		try {
			...
			case IDENT:
				enterOuterAlt(_localctx, 1);
				{
				setState(107); ((AssignContext)_localctx).IDENT = match(IDENT);
				setState(108); match(GETS);
				setState(109); ((AssignContext)_localctx).e = expr();
			...
			case DRAWID:
				enterOuterAlt(_localctx, 2);
				{
				setState(112); match(DRAWID);
				setState(113); ((AssignContext)_localctx).IDENT = match(IDENT);
				setState(114); match(GETS);
				setState(115); ((AssignContext)_localctx).d1 = design();
	...
	public final BexprContext bexpr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(120); ((BexprContext)_localctx).d1 = disj();
			...
			while (_la==OR) {
				...
				setState(123); ((BexprContext)_localctx).d2 = disj();
	...
	public final DisjContext disj() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(131); ((DisjContext)_localctx).c1 = conj();
			...
			while (_la==AND) {
				...
				setState(134); ((DisjContext)_localctx).c2 = conj();
	...
	public final ConjContext conj() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(142); ((ConjContext)_localctx).a1 = aexpr();
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << EQU) | (1L << NEQ) | (1L << LT) | (1L << LEQ) | (1L << GT) | (1L << GEQ))) != 0)) {
				{
				setState(144); ((ConjContext)_localctx).o = relOp();
				setState(145); ((ConjContext)_localctx).a2 = aexpr();
	...
	public final AexprContext aexpr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(164); ((AexprContext)_localctx).p1 = parcela();
			...
			while (_la==PLUS || _la==MINUS) {
				...
				case PLUS:
					{
					setState(166); match(PLUS);
					setState(167); ((AexprContext)_localctx).p2 = parcela();
				...
				case MINUS:
					...
					setState(171); ((AexprContext)_localctx).p2 = parcela();
	...
	public final ParcelaContext parcela() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(179); ((ParcelaContext)_localctx).f1 = fator();
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << TIMES) | (1L << DIVIDE) | (1L << MOD))) != 0)) {
				...
				case TIMES:
					{
					setState(181); match(TIMES);
					setState(182); ((ParcelaContext)_localctx).f2 = fator();
					((ParcelaContext)_localctx).result =  mkComposite(Op.TIMES, _localctx.result, ((ParcelaContext)_localctx).f2.result);
					}
					break;
				case DIVIDE:
					{
					setState(185); match(DIVIDE);
					setState(186); ((ParcelaContext)_localctx).f2 = fator();
					((ParcelaContext)_localctx).result =  mkComposite(Op.DIVIDE, _localctx.result, ((ParcelaContext)_localctx).f2.result);
					}
					break;
				case MOD:
					{
					setState(189); match(MOD);
					setState(190); ((ParcelaContext)_localctx).f2 = fator();
	...
	public final FatorContext fator() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(198); ((FatorContext)_localctx).t1 = termo();
			((FatorContext)_localctx).result =  ((FatorContext)_localctx).t1.result;
			setState(204);
			_la = _input.LA(1);
			if (_la==EXP) {
				{
				setState(200); match(EXP);
				setState(201); ((FatorContext)_localctx).t2 = termo();
	...
	public final TermoContext termo() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(207); ((TermoContext)_localctx).t1 = termo();
			...
			case 2:
				...
				setState(211); ((TermoContext)_localctx).t1 = termo();
			...
			case 3:
				...
				setState(215); ((TermoContext)_localctx).e1 = expr();
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(219); ((TermoContext)_localctx).NUMERO = match(NUMERO);
			...
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(221); ((TermoContext)_localctx).IDENT = match(IDENT);
			...
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(223); ((TermoContext)_localctx).IDENT = match(IDENT);
				setState(224); match(LPAR);
				setState(225); ((TermoContext)_localctx).a = argList();
	...
	public final ArgListContext argList() throws RecognitionException {
		...
		try {
			...
			case LPAR:
				enterOuterAlt(_localctx, 2);
				{
				setState(232); ((ArgListContext)_localctx).e1 = expr();
				...
				while (_la==COMMA) {
					...
					setState(235); ((ArgListContext)_localctx).e2 = expr();
	...
	public final DesignContext design() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(245); ((DesignContext)_localctx).ds1 = shape();
			setState(246); ((DesignContext)_localctx).dp1 = property();
	...
	public final ShapeContext shape() throws RecognitionException {
		...
		try {
			...
			case SQUARE:
				enterOuterAlt(_localctx, 1);
				{
				setState(249); ((ShapeContext)_localctx).SQUARE = match(SQUARE);
			...
			case RECTANGLE:
				enterOuterAlt(_localctx, 2);
				{
				setState(251); ((ShapeContext)_localctx).RECTANGLE = match(RECTANGLE);
			...
			case OVAL:
				enterOuterAlt(_localctx, 3);
				{
				setState(253); ((ShapeContext)_localctx).OVAL = match(OVAL);
			...
			case PENTAGON:
				enterOuterAlt(_localctx, 4);
				{
				setState(255); ((ShapeContext)_localctx).PENTAGON = match(PENTAGON);
			...
			case OCTAGON:
				enterOuterAlt(_localctx, 5);
				{
				setState(257); ((ShapeContext)_localctx).OCTAGON = match(OCTAGON);
			...
			case CIRCLE:
				enterOuterAlt(_localctx, 6);
				{
				setState(259); ((ShapeContext)_localctx).CIRCLE = match(CIRCLE);
			...
			case TRIANGLE:
				...
				{
				setState(261); ((ShapeContext)_localctx).TRIANGLE = match(TRIANGLE);
			...
			case TRAPEZIO:
				...
				{
				setState(263); ((ShapeContext)_localctx).TRAPEZIO = match(TRAPEZIO);
	...
	public final PropertyContext property() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(267); ((PropertyContext)_localctx).height = match(NUMERO);
			setState(268); ((PropertyContext)_localctx).width = match(NUMERO);
			setState(269); ((PropertyContext)_localctx).pColor = color();
	...
	public final ColorContext color() throws RecognitionException {
		...
		try {
			...
			case RED:
				enterOuterAlt(_localctx, 1);
				{
				setState(272); ((ColorContext)_localctx).RED = match(RED);
			...
			case BLUE:
				enterOuterAlt(_localctx, 2);
				{
				setState(274); ((ColorContext)_localctx).BLUE = match(BLUE);
			...
			case BLACK:
				enterOuterAlt(_localctx, 3);
				{
				setState(276); ((ColorContext)_localctx).BLACK = match(BLACK);
			...
			case PURPLE:
				enterOuterAlt(_localctx, 4);
				{
				setState(278); ((ColorContext)_localctx).PURPLE = match(PURPLE);
			...
			case YELLOW:
				enterOuterAlt(_localctx, 5);
