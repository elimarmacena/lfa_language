...
public class CalcParser extends Parser {
	...
	public static final String[] tokenNames = {
		...
		"'black'", "'purple'", "'white'", "'green'", "'pink'", "'yellow'", "DRAWID", 
		"IDENT", "'='", "'+'", "'-'", "'*'", "'/'", "'%'", "'^'", "'('", "')'", 
		"'{'", "'}'", "','", "';'", "'=='", "'!='", "'<'", "'<='", "'>'", "'>='", 
		"WS", "COMMENT"
	};
	public static final int
		...
		RULE_fator = 14, RULE_termo = 15, RULE_argList = 16, RULE_draw = 17, RULE_shape = 18, 
		RULE_property = 19, RULE_color = 20;
	public static final String[] ruleNames = {
		"inicio", "statement", "ifExpr", "whileExpr", "block", "sttmtSeq", "expr", 
		"assign", "bexpr", "disj", "conj", "relOp", "aexpr", "parcela", "fator", 
		"termo", "argList", "draw", "shape", "property", "color"
	};
	...
	public final InicioContext inicio() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << NUMERO) | (1L << NOT) | (1L << IF) | (1L << WHILE) | (1L << DRAWID) | (1L << IDENT) | (1L << MINUS) | (1L << LPAR) | (1L << LBRC))) != 0)) {
				{
				{
				setState(42); ((InicioContext)_localctx).s = statement();
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case LPAR:
				enterOuterAlt(_localctx, 1);
				{
				setState(50); ((StatementContext)_localctx).e = expr();
			...
			case IF:
				...
				{
				setState(54); ((StatementContext)_localctx).i = ifExpr();
			...
			case WHILE:
				...
				{
				setState(57); ((StatementContext)_localctx).w = whileExpr();
			...
			case LBRC:
				...
				{
				setState(60); ((StatementContext)_localctx).b = block();
	...
	public final IfExprContext ifExpr() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(65); match(IF);
				setState(66); ((IfExprContext)_localctx).c = bexpr();
				setState(67); match(THEN);
				setState(68); ((IfExprContext)_localctx).t = statement();
			...
			case 2:
				...
				setState(72); ((IfExprContext)_localctx).c = bexpr();
				setState(73); match(THEN);
				setState(74); ((IfExprContext)_localctx).t = statement();
				setState(75); match(ELSE);
				setState(76); ((IfExprContext)_localctx).e = statement();
	...
	public final WhileExprContext whileExpr() throws RecognitionException {
		...
		try {
			...
			setState(82); ((WhileExprContext)_localctx).c = bexpr();
			setState(83); match(DO);
			setState(84); ((WhileExprContext)_localctx).d = statement();
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(87); match(LBRC);
			setState(88); ((BlockContext)_localctx).st = sttmtSeq();
			setState(89); match(RBRC);
	...
	public final SttmtSeqContext sttmtSeq() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << NUMERO) | (1L << NOT) | (1L << IF) | (1L << WHILE) | (1L << DRAWID) | (1L << IDENT) | (1L << MINUS) | (1L << LPAR) | (1L << LBRC))) != 0)) {
				{
				{
				setState(92); ((SttmtSeqContext)_localctx).s1 = statement();
	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(100); ((ExprContext)_localctx).a = assign();
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(103); ((ExprContext)_localctx).e = bexpr();
	...
	public final AssignContext assign() throws RecognitionException {
		...
		try {
			...
			case IDENT:
				enterOuterAlt(_localctx, 1);
				{
				setState(108); ((AssignContext)_localctx).IDENT = match(IDENT);
				setState(109); match(GETS);
				setState(110); ((AssignContext)_localctx).e = expr();
			...
			case DRAWID:
				enterOuterAlt(_localctx, 2);
				{
				setState(113); match(DRAWID);
				setState(114); ((AssignContext)_localctx).IDENT = match(IDENT);
				setState(115); match(GETS);
				setState(116); ((AssignContext)_localctx).d1 = draw();
	...
	public final BexprContext bexpr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(121); ((BexprContext)_localctx).d1 = disj();
			...
			while (_la==OR) {
				...
				setState(124); ((BexprContext)_localctx).d2 = disj();
	...
	public final DisjContext disj() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(132); ((DisjContext)_localctx).c1 = conj();
			...
			while (_la==AND) {
				...
				setState(135); ((DisjContext)_localctx).c2 = conj();
	...
	public final ConjContext conj() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(143); ((ConjContext)_localctx).a1 = aexpr();
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << EQU) | (1L << NEQ) | (1L << LT) | (1L << LEQ) | (1L << GT) | (1L << GEQ))) != 0)) {
				{
				setState(145); ((ConjContext)_localctx).o = relOp();
				setState(146); ((ConjContext)_localctx).a2 = aexpr();
	...
	public final AexprContext aexpr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(165); ((AexprContext)_localctx).p1 = parcela();
			...
			while (_la==PLUS || _la==MINUS) {
				...
				case PLUS:
					...
					setState(168); ((AexprContext)_localctx).p2 = parcela();
					((AexprContext)_localctx).result =  mkComposite(Op.PLUS, _localctx.result, ((AexprContext)_localctx).p2.result);
					}
					break;
				case MINUS:
					{
					setState(171); match(MINUS);
					setState(172); ((AexprContext)_localctx).p2 = parcela();
	...
	public final ParcelaContext parcela() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(180); ((ParcelaContext)_localctx).f1 = fator();
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << TIMES) | (1L << DIVIDE) | (1L << MOD))) != 0)) {
				...
				case TIMES:
					...
					setState(183); ((ParcelaContext)_localctx).f2 = fator();
				...
				case DIVIDE:
					...
					setState(187); ((ParcelaContext)_localctx).f2 = fator();
					((ParcelaContext)_localctx).result =  mkComposite(Op.DIVIDE, _localctx.result, ((ParcelaContext)_localctx).f2.result);
					}
					break;
				case MOD:
					{
					setState(190); match(MOD);
					setState(191); ((ParcelaContext)_localctx).f2 = fator();
	...
	public final FatorContext fator() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(199); ((FatorContext)_localctx).t1 = termo();
			((FatorContext)_localctx).result =  ((FatorContext)_localctx).t1.result;
			setState(205);
			_la = _input.LA(1);
			if (_la==EXP) {
				{
				setState(201); match(EXP);
				setState(202); ((FatorContext)_localctx).t2 = termo();
	...
	public final TermoContext termo() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(207); match(MINUS);
				setState(208); ((TermoContext)_localctx).t1 = termo();
			...
			case 2:
				...
				setState(212); ((TermoContext)_localctx).t1 = termo();
			...
			case 3:
				...
				setState(216); ((TermoContext)_localctx).e1 = expr();
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(220); ((TermoContext)_localctx).NUMERO = match(NUMERO);
			...
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(222); ((TermoContext)_localctx).IDENT = match(IDENT);
			...
			case 6:
				...
				setState(226); ((TermoContext)_localctx).a = argList();
				setState(227); match(RPAR);
	...
	public final ArgListContext argList() throws RecognitionException {
		...
		try {
			...
			case LPAR:
				enterOuterAlt(_localctx, 2);
				{
				setState(233); ((ArgListContext)_localctx).e1 = expr();
				...
				while (_la==COMMA) {
					...
					setState(236); ((ArgListContext)_localctx).e2 = expr();
	...
	public final DrawContext draw() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(246); ((DrawContext)_localctx).ds1 = shape();
			setState(247); ((DrawContext)_localctx).dp1 = property();
			((DrawContext)_localctx).result =  mkDesign(((DrawContext)_localctx).ds1.result,((DrawContext)_localctx).dp1.result);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ShapeContext shape() throws RecognitionException {
		...
		try {
			...
			case SQUARE:
				enterOuterAlt(_localctx, 1);
				{
				setState(250); ((ShapeContext)_localctx).SQUARE = match(SQUARE);
			...
			case RECTANGLE:
				enterOuterAlt(_localctx, 2);
				{
				setState(252); ((ShapeContext)_localctx).RECTANGLE = match(RECTANGLE);
			...
			case OVAL:
				enterOuterAlt(_localctx, 3);
				{
				setState(254); ((ShapeContext)_localctx).OVAL = match(OVAL);
			...
			case PENTAGON:
				enterOuterAlt(_localctx, 4);
				{
				setState(256); ((ShapeContext)_localctx).PENTAGON = match(PENTAGON);
			...
			case OCTAGON:
				enterOuterAlt(_localctx, 5);
				{
				setState(258); ((ShapeContext)_localctx).OCTAGON = match(OCTAGON);
			...
			case CIRCLE:
				enterOuterAlt(_localctx, 6);
				{
				setState(260); ((ShapeContext)_localctx).CIRCLE = match(CIRCLE);
			...
			case TRIANGLE:
				...
				{
				setState(262); ((ShapeContext)_localctx).TRIANGLE = match(TRIANGLE);
			...
			case TRAPEZIO:
				...
				{
				setState(264); ((ShapeContext)_localctx).TRAPEZIO = match(TRAPEZIO);
	...
	public final PropertyContext property() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(268); ((PropertyContext)_localctx).height = match(NUMERO);
			setState(269); ((PropertyContext)_localctx).width = match(NUMERO);
			setState(270); ((PropertyContext)_localctx).pColor = color();
	...
	public final ColorContext color() throws RecognitionException {
		...
		try {
			...
			case RED:
				enterOuterAlt(_localctx, 1);
				{
				setState(273); ((ColorContext)_localctx).RED = match(RED);
			...
			case BLUE:
				enterOuterAlt(_localctx, 2);
				{
				setState(275); ((ColorContext)_localctx).BLUE = match(BLUE);
			...
			case BLACK:
				enterOuterAlt(_localctx, 3);
				{
				setState(277); ((ColorContext)_localctx).BLACK = match(BLACK);
			...
			case PURPLE:
				enterOuterAlt(_localctx, 4);
				{
				setState(279); ((ColorContext)_localctx).PURPLE = match(PURPLE);
			...
			case YELLOW:
				enterOuterAlt(_localctx, 5);
				{
				setState(281); ((ColorContext)_localctx).YELLOW = match(YELLOW);
			...
			case PINK:
				enterOuterAlt(_localctx, 6);
				{
				setState(283); ((ColorContext)_localctx).PINK = match(PINK);
			...
			case GREEN:
				enterOuterAlt(_localctx, 7);
				{
				setState(285); ((ColorContext)_localctx).GREEN = match(GREEN);
			...
			case WHITE:
				enterOuterAlt(_localctx, 8);
				{
				setState(287); ((ColorContext)_localctx).WHITE = match(WHITE);
	...
	public static final String _serializedATN =
		"\3\uacf5\uee8c\u4f5d\u8b0d\u4a45\u78bd\u1b2f\u3378\3\62\u0126\4\2\t\2"+
		"\4\3\t\3\4\4\t\4\4\5\t\5\4\6\t\6\4\7\t\7\4\b\t\b\4\t\t\t\4\n\t\n\4\13"+
		"\t\13\4\f\t\f\4\r\t\r\4\16\t\16\4\17\t\17\4\20\t\20\4\21\t\21\4\22\t\22"+
		"\4\23\t\23\4\24\t\24\4\25\t\25\4\26\t\26\3\2\3\2\3\2\7\2\60\n\2\f\2\16"+
		"\2\63\13\2\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\5\3B\n"+
		"\3\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\5\4R\n\4\3"+
		"\5\3\5\3\5\3\5\3\5\3\5\3\6\3\6\3\6\3\6\3\6\3\7\3\7\3\7\7\7b\n\7\f\7\16"+
		"\7e\13\7\3\b\3\b\3\b\3\b\3\b\3\b\5\bm\n\b\3\t\3\t\3\t\3\t\3\t\3\t\3\t"+
		"\3\t\3\t\3\t\3\t\5\tz\n\t\3\n\3\n\3\n\3\n\3\n\3\n\7\n\u0082\n\n\f\n\16"+
		"\n\u0085\13\n\3\13\3\13\3\13\3\13\3\13\3\13\7\13\u008d\n\13\f\13\16\13"+
		"\u0090\13\13\3\f\3\f\3\f\3\f\3\f\3\f\5\f\u0098\n\f\3\r\3\r\3\r\3\r\3\r"+
		"\3\r\3\r\3\r\3\r\3\r\3\r\3\r\5\r\u00a6\n\r\3\16\3\16\3\16\3\16\3\16\3"+
		"\16\3\16\3\16\3\16\3\16\7\16\u00b2\n\16\f\16\16\16\u00b5\13\16\3\17\3"+
		"\17\3\17\3\17\3\17\3\17\3\17\3\17\3\17\3\17\3\17\3\17\3\17\3\17