...
public class CalcParser extends Parser {
	...
	public final InicioContext inicio() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << NUMERO) | (1L << NOT) | (1L << IF) | (1L << WHILE) | (1L << IDENT) | (1L << MINUS) | (1L << LPAR) | (1L << LBRC))) != 0)) {
				{
				{
				setState(34); ((InicioContext)_localctx).s = statement();
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case LPAR:
				enterOuterAlt(_localctx, 1);
				{
				setState(42); ((StatementContext)_localctx).e = expr();
			...
			case IF:
				...
				{
				setState(46); ((StatementContext)_localctx).i = ifExpr();
			...
			case WHILE:
				...
				{
				setState(49); ((StatementContext)_localctx).w = whileExpr();
			...
			case LBRC:
				...
				{
				setState(52); ((StatementContext)_localctx).b = block();
	...
	public final IfExprContext ifExpr() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(58); ((IfExprContext)_localctx).c = bexpr();
				setState(59); match(THEN);
				setState(60); ((IfExprContext)_localctx).t = statement();
			...
			case 2:
				...
				setState(64); ((IfExprContext)_localctx).c = bexpr();
				setState(65); match(THEN);
				setState(66); ((IfExprContext)_localctx).t = statement();
				setState(67); match(ELSE);
				setState(68); ((IfExprContext)_localctx).e = statement();
	...
	public final WhileExprContext whileExpr() throws RecognitionException {
		...
		try {
			...
			setState(74); ((WhileExprContext)_localctx).c = bexpr();
			setState(75); match(DO);
			setState(76); ((WhileExprContext)_localctx).d = statement();
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(79); match(LBRC);
			setState(80); ((BlockContext)_localctx).st = sttmtSeq();
			setState(81); match(RBRC);
	...
	public final SttmtSeqContext sttmtSeq() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << NUMERO) | (1L << NOT) | (1L << IF) | (1L << WHILE) | (1L << IDENT) | (1L << MINUS) | (1L << LPAR) | (1L << LBRC))) != 0)) {
				{
				{
				setState(84); ((SttmtSeqContext)_localctx).s1 = statement();
	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(92); ((ExprContext)_localctx).a = assign();
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(95); ((ExprContext)_localctx).e = bexpr();
	...
	public final AssignContext assign() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(100); ((AssignContext)_localctx).IDENT = match(IDENT);
			setState(101); match(GETS);
			setState(102); ((AssignContext)_localctx).e = expr();
	...
	public final BexprContext bexpr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(105); ((BexprContext)_localctx).d1 = disj();
			...
			while (_la==OR) {
				...
				setState(108); ((BexprContext)_localctx).d2 = disj();
	...
	public final DisjContext disj() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(116); ((DisjContext)_localctx).c1 = conj();
			...
			while (_la==AND) {
				...
				setState(119); ((DisjContext)_localctx).c2 = conj();
	...
	public final ConjContext conj() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(127); ((ConjContext)_localctx).a1 = aexpr();
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << EQU) | (1L << NEQ) | (1L << LT) | (1L << LEQ) | (1L << GT) | (1L << GEQ))) != 0)) {
				{
				setState(129); ((ConjContext)_localctx).o = relOp();
				setState(130); ((ConjContext)_localctx).a2 = aexpr();
	...
	public final AexprContext aexpr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(149); ((AexprContext)_localctx).p1 = parcela();
			...
			while (_la==PLUS || _la==MINUS) {
				...
				case PLUS:
					...
					setState(152); ((AexprContext)_localctx).p2 = parcela();
				...
				case MINUS:
					...
					setState(156); ((AexprContext)_localctx).p2 = parcela();
	...
	public final ParcelaContext parcela() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(164); ((ParcelaContext)_localctx).f1 = fator();
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << TIMES) | (1L << DIVIDE) | (1L << MOD))) != 0)) {
				...
				case TIMES:
					{
					setState(166); match(TIMES);
					setState(167); ((ParcelaContext)_localctx).f2 = fator();
				...
				case DIVIDE:
					...
					setState(171); ((ParcelaContext)_localctx).f2 = fator();
				...
				case MOD:
					...
					setState(175); ((ParcelaContext)_localctx).f2 = fator();
	...
	public final FatorContext fator() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(183); ((FatorContext)_localctx).t1 = termo();
			...
			if (_la==EXP) {
				...
				setState(186); ((FatorContext)_localctx).t2 = termo();
	...
	public final TermoContext termo() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(191); match(MINUS);
				setState(192); ((TermoContext)_localctx).t1 = termo();
			...
			case 2:
				...
				setState(196); ((TermoContext)_localctx).t1 = termo();
			...
			case 3:
				...
				setState(200); ((TermoContext)_localctx).e1 = expr();
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(204); ((TermoContext)_localctx).NUMERO = match(NUMERO);
			...
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(206); ((TermoContext)_localctx).IDENT = match(IDENT);
			...
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(208); ((TermoContext)_localctx).IDENT = match(IDENT);
				setState(209); match(LPAR);
				setState(210); ((TermoContext)_localctx).a = argList();
	...
	public final ArgListContext argList() throws RecognitionException {
		...
		try {
			...
			case LPAR:
				enterOuterAlt(_localctx, 2);
				{
				setState(217); ((ArgListContext)_localctx).e1 = expr();
				...
				while (_la==COMMA) {
					...
					setState(220); ((ArgListContext)_localctx).e2 = expr();
	...
	public static final String _serializedATN =
		...
		"\2\23\2\4\6\b\n\f\16\20\22\24\26\30\32\34\36 \"\2\2\u00f3\2)\3\2\2\2\4"+
		"9\3\2\2\2\6I\3\2\2\2\bK\3\2\2\2\nQ\3\2\2\2\f[\3\2\2\2\16d\3\2\2\2\20f"+
		"\3\2\2\2\22k\3\2\2\2\24v\3\2\2\2\26\u0081\3\2\2\2\30\u0095\3\2\2\2\32"+
		"\u0097\3\2\2\2\34\u00a6\3\2\2\2\36\u00b9\3\2\2\2 \u00d8\3\2\2\2\"\u00e6"+
